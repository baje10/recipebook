          ...
          <div className="detailsCol1">
            ...
            >
              ...
              <div className="listCont">
                ...
                <li style = {{ display: recipe.ingredients ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement} {ingredients.measurementCosting} {ingredients.name} - ₱{(parseFloat(recipe.measurement) * parseFloat(ingredients.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients1 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement1} {ingredients1.measurementCosting} {ingredients1.name} - ₱{(parseFloat(recipe.measurement1) * parseFloat(ingredients1.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients2 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement2} {ingredients2.measurementCosting} {ingredients2.name} - ₱{(parseFloat(recipe.measurement2) * parseFloat(ingredients2.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients3 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement3} {ingredients3.measurementCosting} {ingredients3.name} - ₱{(parseFloat(recipe.measurement3) * parseFloat(ingredients3.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients4 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement4} {ingredients4.measurementCosting} {ingredients4.name} - ₱{(parseFloat(recipe.measurement4) * parseFloat(ingredients4.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients5 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement5} {ingredients5.measurementCosting} {ingredients5.name} - ₱{(parseFloat(recipe.measurement5) * parseFloat(ingredients5.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients6 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement6} {ingredients6.measurementCosting} {ingredients6.name} - ₱{(parseFloat(recipe.measurement6) * parseFloat(ingredients6.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients7 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement7} {ingredients7.measurementCosting} {ingredients7.name} - ₱{(parseFloat(recipe.measurement7) * parseFloat(ingredients7.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients8 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement8} {ingredients8.measurementCosting} {ingredients8.name} - ₱{(parseFloat(recipe.measurement8) * parseFloat(ingredients8.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients9 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement9} {ingredients9.measurementCosting} {ingredients9.name} - ₱{(parseFloat(recipe.measurement9) * parseFloat(ingredients9.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients10 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement10} {ingredients10.measurementCosting} {ingredients10.name} - ₱{(parseFloat(recipe.measurement10) * parseFloat(ingredients10.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients11 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement11} {ingredients11.measurementCosting} {ingredients11.name} - ₱{(parseFloat(recipe.measurement11) * parseFloat(ingredients11.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients12 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement12} {ingredients12.measurementCosting} {ingredients12.name} - ₱{(parseFloat(recipe.measurement12) * parseFloat(ingredients12.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients13 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement13} {ingredients13.measurementCosting} {ingredients13.name} - ₱{(parseFloat(recipe.measurement13) * parseFloat(ingredients13.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients14 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement14} {ingredients14.measurementCosting} {ingredients14.name} - ₱{(parseFloat(recipe.measurement14) * parseFloat(ingredients14.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients15 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement15} {ingredients15.measurementCosting} {ingredients15.name} - ₱{(parseFloat(recipe.measurement15) * parseFloat(ingredients15.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients16 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement16} {ingredients16.measurementCosting} {ingredients16.name} - ₱{(parseFloat(recipe.measurement16) * parseFloat(ingredients16.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients17 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement17} {ingredients17.measurementCosting} {ingredients17.name} - ₱{(parseFloat(recipe.measurement17) * parseFloat(ingredients17.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients18 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement18} {ingredients18.measurementCosting} {ingredients18.name} - ₱{(parseFloat(recipe.measurement18) * parseFloat(ingredients18.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients19 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement19} {ingredients19.measurementCosting} {ingredients19.name} - ₱{(parseFloat(recipe.measurement19) * parseFloat(ingredients19.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients20 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement20} {ingredients20.measurementCosting} {ingredients20.name} - ₱{(parseFloat(recipe.measurement20) * parseFloat(ingredients20.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients21 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement21} {ingredients21.measurementCosting} {ingredients21.name} - ₱{(parseFloat(recipe.measurement21) * parseFloat(ingredients21.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients22 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement22} {ingredients22.measurementCosting} {ingredients22.name} - ₱{(parseFloat(recipe.measurement22) * parseFloat(ingredients22.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients23 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement23} {ingredients23.measurementCosting} {ingredients23.name} - ₱{(parseFloat(recipe.measurement23) * parseFloat(ingredients23.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients24 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement24} {ingredients24.measurementCosting} {ingredients24.name} - ₱{(parseFloat(recipe.measurement24) * parseFloat(ingredients24.price)).toFixed(2)}</i></li>
                <li style = {{ display: recipe.ingredients25 ? '' : 'none' }} ><i className = 'instructions'>{recipe.measurement25} {ingredients25.measurementCosting} {ingredients25.name} - ₱{(parseFloat(recipe.measurement25) * parseFloat(ingredients25.price)).toFixed(2)}</i></li>
              </div>
